...
const sqlPath = path.join(root, 'db/migrations/004_work_orders.sql');
...
`);
console.log({ table: tables, columns: cols.map((c) => c.COLUMN_NAME) });
await conn.end();
console.log(`Applied ${statements.length} statements from 004.`);
